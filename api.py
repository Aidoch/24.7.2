...
class PetFriends:
    ...
    def add_new_pet(self,auth_key: json, name: str, animal_type: str, age: str, pet_photo: str) -> json:
        """Метод отправляет (постит) на сервер данные о добавляемом питомце и возвращает статус запроса
    ...
    def add_pet_photo(self, auth_key: json, pet_id: str, pet_photo: str) -> json:
        ...
        запроса и данные питомца в формате JSON"""
    ...
    def add_new_pet_simple(self, auth_key: json, name: str, animal_type: str,
        ...
        """Метод отправляет (постит) на сервер данные о добавляемом питомце без фотографии
         и возвращает статус код и данные добавленного питомца в формате JSON"""
